...
class helper_plugin_randominc extends DokuWiki_Plugin { // DokuWiki_Helper_Plugin
    ...
    function renderXHTML(&$renderer) {
        ...
        if ((@file_exists(DOKU_PLUGIN.'editsections/action.php'))
            && (!plugin_isdisabled('editsections'))) {
            // for Edit Section Reorganizer Plugin
...
/* ---------- Private Methods ---------- */
    ...
    function _showTagLogos() {
        ...
        // resolve shortcuts
        resolve_pageid($taghelper->namespace, $tag, $exists);
    ...
    function _footer($page) {
        ...
        // '<div class="inclmeta">&nbsp;</div>'.DOKU_LF;
